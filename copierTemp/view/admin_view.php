<?php
$admindata = $obj->admin_list();
if(isset($_GET['status']) && $_GET['status'] == 'delete'){
    if(isset($_GET['id'])){
        $delid = $_GET['id'];
        $delete_msg = $obj->delete_admin($delid);
    } else {
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h4 class="card-title"><a type="button" href="create_admin.php" class="btn btn-primary btn-sm">Add New Admin</a></h4>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="width: max-content">
                                                ...
                                                <a href="?status=delete&id=<?php echo $adminlist['id']; ?>" type="button" class="mx-1 btn btn-rounded btn-danger btn-xxs"><span class="btn-icon-start text-white bg-warning"><i class="fa fa-trash"></i></span>Delete</a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php $serial++; } ?>
