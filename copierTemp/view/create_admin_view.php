<?php
    if(isset($_POST['CreateAdmin'])){
        $return_CreateAdmin= $obj->CreateAdmin($_POST);
    }
?>
                ...
                <div class="card">
                    ...
                    <div class="settings-form">
                        <form action="" method="POST" onsubmit="return validateForm()">
                            ...
                            <button class="btn btn-primary" type="submit" name="CreateAdmin" value="CreateAdmin">Submit Now</button>
                        </form>
                    </div>
                </div>
                </div>
