        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="service-img-wrapper col-lg-6 col-md-12 col-sm-12">
                    <div class="image-box">
                        <img draggable="false" src="assets/img/phone.png" class="center-block img-responsive phone-img" alt="">
                        <img draggable="false" src="assets/img/core-img/rings-bg.png" class="center-block img-responsive rings " alt="">
                    </div>
                </div>
            </div>
        </div>
